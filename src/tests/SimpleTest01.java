...
public class SimpleTest01 implements TestData {
	...
	private Course getCourse01() {
		...
		Session session01 = new Session("Theory", 1, tutor01, rooms, ONE_HOUR,
				course01);
		Session session02 = new Session("Studio", 1, tutor02, rooms, ONE_HOUR * 2,
				course01);
		Session session03 = new Session("Live Sound", 1, tutor01, R35,
				ONE_HOUR * 3, course01);
		Session session04 = new Session("Techno", 1, tutor02, rooms, ONE_HOUR,
				course01);
	...
	private Course getCourse02() {
		...
		Session session01 = new Session("Pure Maths", 1, tutor01, rooms, ONE_HOUR * 2,
				course01);
		...
		Session session03 = new Session("CD Production", 1, tutor01, R30,
				ONE_HOUR, course01);
		Session session04 = new Session("Statistics", 1, tutor02, rooms, ONE_HOUR,
				course01);
		Session session05 = new Session("Electronics", 1, tutor01, rooms, ONE_HOUR,
				course01);
		Session session06 = new Session("Mechanics (Maths)", 1, tutor01, R35, ONE_HOUR,
				course01);
		Session session07 = new Session("Polar Patterns", 1, tutor01, rooms,
				ONE_HOUR * 3, course01);
		Session session08 = new Session("Impedences", 1, tutor02, R30, ONE_HOUR,
				course01);
