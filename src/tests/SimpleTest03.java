...
public class SimpleTest03 implements TestData {
	...
	private Course getCourse01() {
		...
		Session session01 = new Session("Theory", 1, tutor01, rooms, ONE_HOUR,
				course01);
		Session session02 = new Session("Studio", 1, tutor02, R30, (ONE_HOUR * 3) + (ONE_HOUR / 4),
				course01);
		...
		Session session07 = new Session("Acoustics", 1, tutor01, rooms,
				(ONE_HOUR * 3) + (ONE_HOUR / 4), course01);
	...
	private Course getCourse02() {
		...
		Session session03 = new Session("CD Production", 1, tutor01, R30,
				ONE_HOUR, course01);
		Session session04 = new Session("Statistics", 1, tutor02, rooms, ONE_HOUR + (ONE_HOUR / 4),
				course01);
