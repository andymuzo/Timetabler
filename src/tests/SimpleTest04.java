...
public class SimpleTest04 implements TestData {
	...
	private Course getCourse03() {
		...
		Session session06 = new Session("Pottery", 1, tutor02, R35, ONE_HOUR + (ONE_HOUR / 2),
				course01);
		Session session07 = new Session("Textiles", 1, tutor02, rooms,
				ONE_HOUR * 2 + (ONE_HOUR / 2), course01);
		Session session08 = new Session("Photography", 1, tutor02, R30, ONE_HOUR + (ONE_HOUR / 2),
				course01);
